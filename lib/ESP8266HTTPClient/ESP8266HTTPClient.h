...
#endif // ifdef DEBUG_ESP_HTTP_CLIENT

#ifndef DEBUG_HTTPCLIENT
#define DEBUG_HTTPCLIENT(...)
#endif // ifndef DEBUG_HTTPCLIENT
...
public:
  ...
  String header(size_t i);          // get request header value by
                                    // number
  String headerName(size_t i);      // get request header name by
                                    // number
